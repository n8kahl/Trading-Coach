...
export default function ActionsDock({ onAction, disabledActions, layout = "vertical" }: ActionsDockProps) {
        ...
        return (
          <button
            ...
            className={clsx(
              ...
              "border border-neutral-800/80 bg-neutral-950/80 text-neutral-100 shadow-lg shadow-emerald-500/20",
